...
class Photo(Gtk.Window):
    ...
    def __init__(self):
       ...
       # self.left.pack_start(self.Label5, True, True, 0)
       # self.Label05 = Gtk.Label("")
       # self.left.pack_start(self.Label05, True, True, 0)
       # self.Label22 = Gtk.Label("")
       # self.left.pack_start(self.Label22, True, True, 0)
        
       # self.Label07 = Gtk.Label("Great1")
       # self.left.pack_start(self.Label07, True, True, 0)
       # self.Label6 = Gtk.Label("Great2")
       # self.left.pack_start(self.Label6, True, True, 0)
       # self.Label21 = Gtk.Label("")
       # self.left.pack_start(self.Label21, True, True, 0)

       #self.Label09 = Gtk.Label("")
       # self.left.pack_start(self.Label09, True, True, 0)
       # self.Label7 = Gtk.Label("Crop")
       # self.left.pack_start(self.Label7, True, True, 0)
       # self.Label8 = Gtk.Label("Cropborder")
       # self.left.pack_start(self.Label8, True, True, 0)
       # self.Label9 = Gtk.Label("Invert")
       # self.left.pack_start(self.Label9, True, True, 0)
       # self.Label10 = Gtk.Label("Rgba")
       # self.left.pack_start(self.Label10, True, True, 0)
       # self.Label11 = Gtk.Label("Cmyk")
       # self.left.pack_start(self.Label11, True, True, 0)
       # self.Label12 = Gtk.Label("Sepia" )
       # self.left.pack_start(self.Label12, True, True, 0)
       # self.Label15 = Gtk.Label("Rotate")
       # self.left.pack_start(self.Label15, True, True, 0)
       #self.Label16 = Gtk.Label("Resize")
       # self.left.pack_start(self.Label16, True, True, 0)
       # self.Label17 = Gtk.Label("FBcover")
       # self.left.pack_start(self.Label17, True, True, 0)
